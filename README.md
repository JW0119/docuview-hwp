...
- 최근 문서 목록 저장/재열기
- PDF 원본 비율 다중 페이지 렌더링
- TXT/MD/CSV 텍스트 표시
- HWP/HWPX rhwp Rust/WASM 렌더링 엔진 WebView 연결
- HWPX ZIP/XML 기반 본문/표 텍스트 추출 fallback
- DOCX/XLSX/PPTX OpenXML 텍스트 추출 표시
- 현재 문서 내 검색
- HWP 바이너리 및 레거시 Office 문서 변환 엔진 슬롯
