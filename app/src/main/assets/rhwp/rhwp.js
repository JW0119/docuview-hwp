...
export class HwpDocument {
     ...
     * @returns {number}
     */
    renderPageSvgStatus(page_num) {
        const ret = wasm.hwpdocument_renderPageSvgStatus(this.__wbg_ptr, page_num);
        return ret >>> 0;
    }
}
 ...
 * @returns {number}
 */
export function lastStringLen() {
    const ret = wasm.lastStringLen();
    return ret >>> 0;
}
 ...
 * @returns {number}
 */
export function lastStringPtr() {
    const ret = wasm.lastStringPtr();
    return ret >>> 0;
}

export function lastString() {
    return getStringFromWasm0(lastStringPtr(), lastStringLen());
}
